...
function programarNotificaciones() {
  const juegos = [
    { titulo: 'Dream 😴', hora: '23:57', fecha: '2025-06-30' },
...
async function pedirPermisoFirebase() {
  try {
    ...
    const token = await messaging.getToken({
      vapidKey: 'BNf35iKHn9Zvu0KuDYPAv_TYPnuVmfwwqZonIZ7lK-Uw-vtzygUNmLrlDDDDWCiI5sn9wbv57PyqZHAPnoIN83E' // Debes poner tu propia clave VAPID de Firebase
    });
